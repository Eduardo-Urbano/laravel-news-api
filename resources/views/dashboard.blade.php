    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900 dark:text-gray-100">
                {{ __("Bem-vindo ao seu painel!") }}
            </div>

            <!-- Ações rápidas -->
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="{{ route('posts.create') }}" class="bg-blue-500 text-white p-4 rounded hover:bg-blue-600 text-center">
                    Criar Postagem
                </a>
                <a href="{{ route('categories.create') }}" class="bg-green-500 text-white p-4 rounded hover:bg-green-600 text-center">
                    Criar Categoria
                </a>
            </div>
